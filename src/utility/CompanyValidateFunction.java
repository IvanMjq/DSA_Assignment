...
public class CompanyValidateFunction {
    ...
    public static boolean isValidName(String name) {
        ...
        if (!name.matches("^[a-zA-Z0-9\\s'.-]{3,50}$")) {
            System.out.println("Invalid Company Name. Must be 3–50 characters and contain only letters, numbers, spaces, ', ., or -.");
            return false;
        }
        return true;
    }
    ...
    public static boolean isValidPhone(String phone) {
        ...
        if (!phone.matches("^0\\d{1,2}-\\d{7,8}$")) {
            System.out.println("Invalid Phone Number. Format must be 0X-XXXXXXX or 0XX-XXXXXXXX.");
            return false;
        }
        return true;
    }
    ...
    public static boolean isValidEmail(String email) {
        if (email == null || email.isEmpty()) {
            System.out.println("Email Address cannot be null or empty.");
            return false;
        }
        if (!email.matches("^[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\\.[A-Za-z]{2,}$")) {
            System.out.println("Invalid Email Address. Please enter a valid format (e.g. example@mail.com).");
            return false;
        }
        return true;
    }
    ...
    public static boolean isValidStreetAddress(String streetAddress) {
        if (streetAddress == null || streetAddress.isEmpty()) {
            System.out.println("Street Address cannot be null or empty.");
            return false;
        }
        if (!streetAddress.matches("^[a-zA-Z0-9\\s,.-]{5,100}$")) {
            System.out.println("Invalid Street Address. Must be 5–100 characters with letters, numbers, spaces, commas, periods, or hyphens.");
            return false;
        }
        return true;
    }
    ...
    public static boolean isValidArea(String area) {
        ...
        if (!area.matches("^[a-zA-Z\\s]{2,50}$")) {
            System.out.println("Invalid Area. Only letters and spaces allowed, 2–50 characters.");
            return false;
        }
        return true;
    }
    ...
    public static boolean isValidState(String state) {
        if (!state.matches("^[a-zA-Z\\s]{2,50}$")) {
            System.out.println("Invalid State. Only letters and spaces allowed, 2–50 characters.");
            return false;
        }
        return true;
    }
    ...
    public static boolean isValidFoundedYear(int year) {
        ...
        if (year < 1800 || year > currentYear) {
            System.out.println("Invalid Founded Year. Must be between 1800 and " + currentYear + ".");
            return false;
        }
        return true;
    }
    ...
    public static Company isValidCompanyId(String id, ListInterface<Company> companyList) {
        ...
        if (!id.matches(prefixPattern)) {
            System.out.println("Invalid ID format. ID should follow the format 'C-<number>' (e.g. C-1, C-2).");
            return null;
        }
