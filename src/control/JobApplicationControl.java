    ...
    public void jobPostingListing() {
        for (int i = 1; i <= companyList.size(); i++) {
            ...
            for (int j = 1; j <= company.getJobPostingList().size(); j++) {
                ...
                System.out.println("---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------");
                System.out.printf("| %-15s | %-30s | %-15s | %-30s | %-300s | %-15.2f | %-15.2f | %-15d | %-15s |\n",
                        jp.getCompany().getId(),
...
//                    System.out.println(jp);
                    ...
                    if (jobType != null && desiredJob[i] != null && jobType.trim().equalsIgnoreCase(desiredJob[i].trim())) {
                        System.out.println("------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------");
                        System.out.printf("| %-15s | %-30s | %-15s | %-30s | %-30s | %-300s | %-15.2f | %-15.2f | %-15d | %-15s |\n",
                            jp.getCompany().getId(),
                            jp.getCompany().getName(),
                            jp.getJob().getId(),
                            jp.getJob().getTitle(),
